    ...
    $(document).ready(function() {
        ...
        if (celLength < 10 || celLength > 11) {
            if (!$(this).hasClass('erro')) {
                alert('Número de celular deve ter 10 ou 11 dígitos.');
                $(this).addClass('erro'); // Adiciona classe para evitar repetição do alerta
                $(this).focus();
            }
        } else {
            $(this).removeClass('erro'); // Remove erro se estiver correto
        }
    });
